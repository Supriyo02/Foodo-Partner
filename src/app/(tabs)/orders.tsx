...
const SectionHeader = ({title, count, onToggle, collapsed}:{title:string; count?:number; onToggle?:()=>void; collapsed?:boolean}) => (
  <Pressable onPress={onToggle} className="flex-row items-center justify-between px-1 py-3">
          ...
          <View className="p-4">
            ...
            <View className="mb-6">
              ...
              {!collapsedIncoming && (
                ...
                // ) : 
                (
                  <FlatList data={incomingList} keyExtractor={keyExtractor} renderItem={renderIncoming} scrollEnabled={false} />
                )
              )}
            </View>
            ...
            <View className="mb-6">
              ...
              {!collapsedPreparing && (
                preparing === null ? (
                  ...
                  <FlatList data={preparingList} keyExtractor={keyExtractor} renderItem={renderPreparing} scrollEnabled={false} />
                )
              )}
            </View>
            ...
            <View className="mb-6">
              ...
              {!collapsedOut && (
                outForDelivery === null ? (
                  ...
                  <FlatList data={outList} keyExtractor={keyExtractor} renderItem={renderOut} scrollEnabled={false} />
                )
              )}
            </View>
            ...
            <View className="mb-20">
              ...
              {!collapsedDelivered && (
                delivered === null ? (
                  ...
                  <FlatList data={deliveredList} keyExtractor={keyExtractor} renderItem={renderDelivered} scrollEnabled={false} />
                )
              )}
            </View>
          </View>
